...
setupfunc ()
{
    ...
    cp /app/GeminiClubSetup/$3 /home/core
    ...
    (cat "/app/GeminiClubSetup/mentorAllocation_alias.sh" ; cat "/app/GeminiClubSetup/displayStatus_alias.sh") >> /home/core/.bashrc
    ...
    do 
        ...
        (cat "/app/GeminiClubSetup/domainPref_alias.sh" ; cat "/app/GeminiClubSetup/submitTask_alias.sh" ) >> /home/core/mentees/$mentee/.bashrc
    done
    ...
    do
        ...
        cat "/app/GeminiClubSetup/submitTask_alias.sh" >> /home/core/mentors/Webdev/$mentor/.bashrc
    ...
    do
        ...
        # Add alias files to .bashrc file of $mentor
        cat "/app/GeminiClubSetup/submitTask_alias.sh" >> /home/core/mentors/Appdev/$mentor/.bashrc
    ...
    do
        ...
        # Add alias files to .bashrc file of $mentor
        cat "/app/GeminiClubSetup/submitTask_alias.sh" >> /home/core/mentors/Sysad/$mentor/.bashrc
...
setupfunc /app/GeminiClubSetup/mentor_details.txt /app/GeminiClubSetup/mentee_details.txt mentee_domain.txt 
